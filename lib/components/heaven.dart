...
class OrangeLemon extends StatefulWidget {
  const OrangeLemon({super.key});

  @override
  State<OrangeLemon> createState() => _OrangeLemonState();
}

class _OrangeLemonState extends State<OrangeLemon> {
  ...
  Future initPlayer() async {
    ...
    player = AudioPlayer();
    path = AssetSource('audio/heaven.mp3');
