...
class Paramore extends StatefulWidget {
  const Paramore({super.key});

  @override
  State<Paramore> createState() => _ParamoreState();
}

class _ParamoreState extends State<Paramore> {
  ...
  Future initPlayer() async {
    ...
    player = AudioPlayer();
    path = AssetSource('audio/paramore.mp3');
